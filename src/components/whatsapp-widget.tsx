...
export function WhatsAppWidget() {
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[100] bg-[#25D366] text-white p-3.5 md:p-4 rounded-full shadow-lg hover:scale-110 hover:shadow-xl hover:bg-[#20ba59] active:scale-95 transition-all duration-300 group"
