      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          ...
          <div className="w-full lg:w-[65%] grid grid-cols-2 sm:grid-cols-3 gap-8 gap-y-10">
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-3 text-[13px] text-gray-500">
                ...
                <li><Link href="/shipping-delivery" className="hover:text-black transition-colors">Shipping Policy</Link></li>
                <li><Link href="/returns-refunds" className="hover:text-black transition-colors">Return Policy</Link></li>
              </ul>
            </div>
        ...
        <div className="pt-6 border-t border-zinc-200 flex flex-col md:flex-row items-center justify-between gap-4 text-[13px] text-gray-500">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            ...
            <Link href="/shipping-delivery" className="hover:text-black transition-colors">Shipping Policy</Link>
            <Link href="/returns-refunds" className="hover:text-black transition-colors">Return Policy</Link>
          </div>
        </div>
      </div>
    </footer>
