            ...
            <section className="order-1 lg:col-start-2 lg:row-start-1 bg-white rounded-[2rem] p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-4">
                  <div className="relative w-[72px] h-[72px] rounded-full overflow-hidden bg-gray-100 shrink-0 shadow-sm flex items-center justify-center">
                    <User className="w-8 h-8 text-zinc-400" />
                  </div>
                  <div>
                    <h1 className="text-[22px] font-serif text-zinc-900 leading-tight">Hi, muhammed</h1>
                    <p className="text-zinc-500 text-[13px] mt-1 tracking-tight">Brighten your space, elevate your mood.</p>
                  </div>
                </div>
