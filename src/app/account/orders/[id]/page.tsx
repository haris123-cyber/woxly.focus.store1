        ...
        <div className="max-w-6xl mx-auto px-6 pt-12">
          ...
          <div className="mb-12">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-line">
              <div>
                <span className="text-forest text-sm font-bold uppercase tracking-wider mb-2 block">Order {demoOrder.number}</span>
                <h1 className="text-4xl font-serif text-ink">{demoOrder.status}</h1>
                <p className="text-muted mt-2 text-lg">Placed on {demoOrder.date}</p>
              </div>
              ...
              <aside className="flex flex-col gap-6">
                ...
                <section className="bg-white border border-line rounded-3xl p-8 shadow-sm">
                  ...
                  <div className="flex flex-col gap-3 text-sm">
                    <div className="flex justify-between text-muted"><span>Subtotal</span><span className="text-ink font-medium">₹3,499</span></div>
                    <div className="flex justify-between text-muted"><span>Delivery</span><span className="text-ink font-medium">Free</span></div>
                    <div className="h-px bg-line my-1" />
                    <div className="flex justify-between text-ink text-base"><strong>Total</strong><strong>₹3,499</strong></div>
                  </div>
                </section>
              </aside>
